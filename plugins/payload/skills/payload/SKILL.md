...
| CSS breaks admin panel   | Scope frontend CSS with `:where()`       | [PAYLOAD-GOTCHAS.md#css-isolation-frontend-vs-payload-admin](reference/PAYLOAD-GOTCHAS.md#css-isolation-frontend-vs-payload-admin) |
| Admin CSS missing in prod| Static CSS file via providers component   | [PAYLOAD-GOTCHAS.md#payload-css-build-stripping-bug](reference/PAYLOAD-GOTCHAS.md#payload-css-build-stripping-bug)                |
